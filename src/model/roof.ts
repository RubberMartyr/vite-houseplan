...
export function buildRoofMeshes(): {
  ...
  console.log('BACK HIP CHECK', { baseFrontZ, ridgeFrontZ, ridgeBackZ, eaveBackZ, frontApexOffset });
  ...
  const xRightBack = findRightXAtZ(rightSegments, eaveBackZ, bounds.maxX);
